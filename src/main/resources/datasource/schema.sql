...
CREATE TABLE `sys_dept` (
  ...
  PRIMARY KEY (`dept_id`),
  KEY `sys_dept_user_code` (`operator`),
  KEY `fk_sys_dept_par_id` (`par_id`)
...
CREATE TABLE `sys_role_perm` (
  ...
  `update_ip` varchar(20) NOT NULL COMMENT '最后修改者的ip',
  PRIMARY KEY (`id`),
  KEY `fk_sys_role_perm_perm_id` (`perm_id`),
  KEY `fk_sys_role_perm_role_id` (`role_id`),
...
CREATE TABLE `sys_user_role` (
  ...
  KEY `fk_sys_role_perm_user_id` (`user_id`),
